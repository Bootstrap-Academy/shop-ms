<p>
  ...
  [![CI](https://github.com/Bootstrap-Academy/shop-ms/actions/workflows/ci.yml/badge.svg)](https://github.com/Defelo/fastapi-template/actions/workflows/ci.yml)
...
#### SSH (recommended)
```bash
git clone --recursive git@github.com:Bootstrap-Academy/shop-ms.git
```

#### HTTPS
```bash
git clone --recursive https://github.com/Bootstrap-Academy/shop-ms.git
```
