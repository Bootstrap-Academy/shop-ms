...
class PremiumStatus(BaseModel):
    ...
    until: float | None = Field(description="End timestamp of the current premium membership.")
    autopay: str | None = Field(description="Premium plan used for automatic renewals.")
